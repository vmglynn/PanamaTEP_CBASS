...
popmap <- read.csv("~/holobiont_2020-2021/ADMIXTURE_15July2024/popmap_17Oct2024.csv", fileEncoding="UTF-8-BOM")
head(popmap)
```
```{r}
...
###Reorder so that pop 1 is shown first on the plot
